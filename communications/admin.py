"""Django Admin for Communications App - Simplified without multi-tenancy"""
...
class EventAdmin(admin.ModelAdmin):
    list_display = ['title', 'event_type', 'start_date', 'end_date', 'is_published', 'is_featured']
...
class AnnouncementAdmin(admin.ModelAdmin):
    list_display = ['title', 'priority', 'created_by', 'is_published', 'published_date', 'expiry_date']
